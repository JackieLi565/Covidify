...
function Portal() {
  ...
  return (
    <div className="bg-darkGreen h-screen flex flex-col justify-center items-center gap-2">
      <h1 className="text-9xl text-pale">Covidify</h1>
      <h2 className="slogan">A receipt for the pandemic</h2>
      <p className="desc">
